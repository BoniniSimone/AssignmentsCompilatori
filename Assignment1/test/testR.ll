...
define dso_local void @strength_red() #0 {
  ...
  %14 = mul i32 %13, 17
  %15 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef %8)
  %16 = call i32 (ptr, ...) @printf(ptr noundef @.str.6, i32 noundef %10)
  %17 = call i32 (ptr, ...) @printf(ptr noundef @.str.7, i32 noundef %12)
  %18 = call i32 (ptr, ...) @printf(ptr noundef @.str.8, i32 noundef %14)
  ret void
}
...
define dso_local void @multi_ins_opt() #0 {
  ...
  %11 = sub nsw i32 %10, 1
  %12 = add nsw i32 %11, 1
  %13 = call i32 (ptr, ...) @printf(ptr noundef @.str.11, i32 noundef %9)
  ret void
}
